  ...
  })()(
    {
          ...
          module.exports = function(options) {
            var main = function() {
              ...
              var startStylesAndEvents = function() {
                var buttonClose = document.getElementById(
                  "buttonCloseUpdateBrowser"
                );
                var buttonUpdate = document.getElementById(
                  "buttonUpdateBrowser"
                );
              ...
              var getmessage = function(lang) {
                var defaultMessages =
                  languageMessages[lang] || languageMessages.ko;
      ...
      3: [
        function(require, module, exports) {
          module.exports = {
            ko: {
              outOfDate: "지원되지 않은 브라우저 입니다!",
              unsupported: "크롬(Chrome) 브라우저로 접속해주세요!",
              update: {
                web:
                  "코드라이언은 크롬(Chrome) 브라우저 PC환경에 최적화 되어있습니다!",
                googlePlay:
                  "코드라이언은 크롬(Chrome) 브라우저 PC환경에 최적화 되어있습니다!",
                appStore:
                  "코드라이언은 크롬(Chrome) 브라우저 PC환경에 최적화 되어있습니다!"
